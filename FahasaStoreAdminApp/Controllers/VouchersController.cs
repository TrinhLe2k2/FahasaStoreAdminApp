...
{
    public class VouchersController : GenericController<Voucher, VoucherModel, VoucherDTO, int>
    {
        private readonly IVoucherService _VoucherService;
        public VouchersController(IVoucherService VoucherService, IMapper mapper, IImageUploader imageUploader) : base(VoucherService, mapper, imageUploader)
        {
